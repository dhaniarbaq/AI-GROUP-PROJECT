...
if input_option == "Headline/Text":
    ...
    if url_input:
        try:
            ...
            st.error("❌ Could not fetch text from URL.")
...
if user_input:
    ...
    if combined_score >= 0.5:
        st.warning("⚠️ The content is likely **FAKE NEWS**. Verify sources carefully!")
    else:
        st.success("✅ The content appears **REAL**. Always cross-check sources!")
